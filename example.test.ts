import { test, expect, describe, beforeEach, afterEach, mock, spy } from './packages/bugsbasters/src';
...
describe('Mocking', () => {
  ...
  test('mock resolves promise', async () => {
...
// Example of intentional failure (commented out)
// test('divides by zero', () => {
//   expect(1 / 0).toBe(0);  // This would fail
// });
